    ...
    <div className="dashboard-container">
      ...
      <div className="welcome-section animate-fadeInUp">
        <MDBTypography tag='h1' className="welcome-title">
          Welcome to TaskMate, {user?.username || 'User'}!
        </MDBTypography>
        <p className="mb-0">A snapshot of your tasks and activities</p>
      </div>
      ...
      <section className="quick-actions">
        <MDBTypography tag='h2' className="mb-4">Rapid Actions</MDBTypography>
