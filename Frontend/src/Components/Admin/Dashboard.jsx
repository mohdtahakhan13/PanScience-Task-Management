...
//       backgroundColor: ['#5BB98C', '#F2B872'], // Muted teal + soft warm orange
...
//       data: [priorityCounts.high, priorityCounts.medium, priorityCounts.low],
//       backgroundColor: ['#D95D5D', '#E9A178', '#6CA6D9'], // Soft red, warm beige-orange, desaturated sky blue
//       borderColor: ['#D95D5D', '#E9A178', '#6CA6D9'],
//       borderWidth: 1
//     }]
//   }
// });
  ...
  return (
    <MDBContainer fluid className="py-5">
          <div className="welcome-section animate-fadeInUp">
              ...
              <p className="mb-0">Track, analyze, and act — all from here.</p>
            </div>
          ...
          <MDBCard>
            <MDBCardBody>
              <div className="d-flex align-items-center">
                ...
                <h5 className="mb-0 me-3">All Users</h5>
                <select 
                  className="form-select w-auto"
                  value={selectedUser}
                  onChange={handleUserChange}
                >
                  <h5 value="all">All Users</h5>
                  {users.map(user => (
